...
class BuildingManagerDetailForm extends Component
{
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        return view('livewire.building-manager-detail-form', compact('building'));
    }
    ...
    public function validateData()
    {
        if ($this->currentStep == 1) {
            ...
            $building_data = Building::where('manager_id', Auth::id())->where('id', $this->building_id)->first();
...
//            if ($building_detail) {
            return redirect()->route('property_manager.building.index')->with(['message' => 'Building Extra Detail Add SuccessFully', 'alert' => 'success',]);
            /*} else {
