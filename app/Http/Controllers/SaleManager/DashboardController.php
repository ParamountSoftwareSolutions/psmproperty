...
class DashboardController extends Controller
{
    public function index(){
        ...
        $sales = BuildingSale::with('customer')->where('property_admin_id', $assign_data->property_admin_id)->where(['order_type' => 'sale'])->get();
        $leads = BuildingSale::where(['property_admin_id' => $assign_data->property_admin_id, 'order_type' => 'lead'])->get();
        $sale = BuildingSale::where(['property_admin_id' => $assign_data->property_admin_id, 'order_type' => 'sale', 'order_status' => 'active'])->get();
        $mature_leads = BuildingSale::where(['property_admin_id' => $assign_data->property_admin_id, 'order_type' => 'sale', 'order_status' => 'mature'])->get();
        $meeting = BuildingSale::where(['property_admin_id' => $assign_data->property_admin_id, 'order_type' => 'lead', 'order_status' => 'arrange_meeting'])->get();
