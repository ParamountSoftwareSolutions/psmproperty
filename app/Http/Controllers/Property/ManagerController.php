...
class ManagerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach($building as $id){
            ...
            $assign_data->property_admin_id = Auth::id();
            $assign_data->manager_id = $manager->id;
            $assign_data->save();
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        $manager->cnic = $request->cnic;
        $manager->save();
        $assign_building = BuildingAssignUser::where('manager_id', $manager->id)->get()->pluck('building_id')->toArray();
        ...
        if ($building_reassign !== null){
                BuildingAssignUser::where(['manager_id' => $manager->id])->whereIn('building_id', $building_reassign)->delete();
        }
    ...
    public function destroy($id)
    {
        ...
        $user->delete();
        BuildingAssignUser::where('manager_id', $id)->delete();
