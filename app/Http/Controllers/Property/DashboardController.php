...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $sale = BuildingSale::where(['property_admin_id' => $assign_data->property_admin_id, 'order_type' => 'sale'])->get();
...
//dd($data);
        return view('property.index', compact('sales', 'leads', 'un_paid_amount', 'paid_amount', 'total_expense', 'expense', 'expense_labors',
