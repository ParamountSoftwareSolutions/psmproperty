...
class EmployeePayrollController extends Controller
{
    ...
    public function index()
    {
        ...
        $employee = User::with('building_employee', 'building_employee_payroll')
            ...
            ->get();
        return view('accountant.hrm.employee_payroll.index', compact('employee'));
    }
    ...
    public function edit($id)
    {
        ...
        $employee = User::with('building_employee')
            ...
            ->findOrFail($id);
        return view('accountant.hrm.employee_payroll.edit', compact('employee'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($employee_payroll) {
            return redirect()->route('accountant.employee_payroll.index')->with($this->message('Employee Pay Update Successfully', 'success'));
        } else {
