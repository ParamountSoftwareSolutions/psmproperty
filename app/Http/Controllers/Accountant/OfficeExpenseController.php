...
class OfficeExpenseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('accountant.office_expense.index', compact('office_expenses'));
    }
    ...
    {
        $building = Helpers::custom_building_detail();
        return view('accountant.office_expense.create', compact('building'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $expense->save();
        if($expense){
            return redirect()->route('accountant.office_expense.index')->with(['alert' => 'success', 'message' =>  'Expense Create Successfully']);
        } else{
    ...
    public function edit($id)
    {
        ...
        $building = Helpers::custom_building_detail();
        return view('accountant.office_expense.edit', compact('office_expense', 'building'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $office_expense->save();
        if($office_expense){
            return redirect()->route('accountant.office_expense.index')->with(['alert' => 'success', 'message' => 'Office Expense Update Successfully']);
        } else{
