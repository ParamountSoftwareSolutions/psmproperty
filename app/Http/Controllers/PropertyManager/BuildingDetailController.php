...
=======
    public function create($panel, $id)
>>>>>>> c29844fb3d91611c6773017d310a35589debc1ec
    {
...
=======
            return redirect()->route('property_manager.building_details.index',['panel' => Helpers::user_login_route()['panel']])->with($this->message('Building Extra Detail update SuccessFully', 'success'));
>>>>>>> c29844fb3d91611c6773017d310a35589debc1ec
        } else {
