...
class ReportController extends Controller
{
    ...
    public function expenseSummary(Request $request)
    {
        ...
        $manager = User::with('property_admin1')->where('id', Auth::id())->first();
        $building_list = Building::where('user_id', $manager->property_admin1->id)->get();
        $building_id = Building::where('user_id', $manager->property_admin1->id)->get()->pluck('id');
