...
class ExpenseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('property_manager.expense.index', compact('expenses'));
    }
    ...
    public function create()
    {
        ...
        return view('property_manager.expense.create', compact('building'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($expense){
            return redirect()->route('property_manager.expense.index')->with(['alert' => 'success', 'message' =>  'Expense Create Successfully']);
        } else{
    ...
    public function edit($id)
    {
        ...
        $building = Helpers::building_detail();
        return view('property_manager.expense.edit', compact('expense', 'building'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($expense){
            return redirect()->route('property_manager.expense.index')->with(['alert' => 'success', 'message' => 'Expense Update Successfully']);
        } else{
    ...
    public function destroy($id)
    {
        ...
        $labor->delete();
        if($expense){
            return response()->json(['status' => 'success', 'message' =>  'Expense Delete Successfully']);
        } else{
            return response()->json(['status' => 'error', 'message' =>  'Expense Delete Error']);
        }
    }
    ...
    public function generatePDF(Request $request)
    {
        ...
        /*$pdf = PDF::loadView('property_manager.pdf.expense_report', $expense);
