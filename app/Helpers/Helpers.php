...
//        dd($admin);
    ...
    public static function display($text = null)
    {
        // $ci = &get_instance();
        // $ci->load->database();
    ...
    public function allpheadtable($headlist)
    {
        ...
        foreach ($headlist as $menu) {
            ...
            if (!empty($menu->sub)) {
                Helpers::all_subpheadtable($menu->sub);
            }
        }
    }

    public static function all_subpheadtable($sub_menu)
    {
