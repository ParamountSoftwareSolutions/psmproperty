...
Route::group(['prefix'=>'v1/property', 'namespace' => 'Api\Building'], function(){
    ...
    Route::group(['middleware' => ['auth:api', 'role:user', 'building_app_user']], function(){
        ...
        Route::get('about/{id}', 'PageController@about');
        Route::get('term&condition/{building_id}', 'PageController@termCondition');
        Route::get('privacy-policy/{building_id}', 'PageController@privacyPolicy');
        Route::get('faq/{building_id}', 'PageController@faq');
    ...
    Route::group(['namespace' => 'Guest'], function() {
        ...
        Route::get('properties/{app_key}', 'BuildingController@property');
        Route::get('single-property/{app_key}/{id}', 'BuildingController@single_property');
        ...
        Route::get('about/{app_key}/{id}', 'PageController@about');
        Route::get('term&condition/{app_key}/{building_id}', 'PageController@termCondition');
        Route::get('privacy-policy/{app_key}/{building_id}', 'PageController@privacyPolicy');
        Route::get('faq/{app_key}/{building_id}', 'PageController@faq');
    });
});
