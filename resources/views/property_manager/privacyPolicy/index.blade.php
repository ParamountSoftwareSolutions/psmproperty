                                        ...
                                        @forelse($privacyPolicy as $result)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" data-url="{{ route('property_manager.privacyPolicy.destroy',$result->id) }}" title="Delete" data-token="{!! csrf_token() !!}" class="btn btn-danger px-1 py-0 deleteBtn">
