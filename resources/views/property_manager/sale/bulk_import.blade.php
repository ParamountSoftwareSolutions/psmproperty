                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <form class="product-form" action="{{ route('property_manager.sale.bulk.import', (new App\Helpers\Helpers)->user_login_route()) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
