                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($sales as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" data-url="{{ route('property_manager.sale.online_booking.destroy',$data->id) }}" title="Delete" data-token="{!! csrf_token() !!}" class="btn btn-danger px-1 py-0 deleteBtn">
