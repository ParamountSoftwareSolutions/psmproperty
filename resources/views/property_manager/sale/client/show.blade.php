...
=======
                                                    <button onclick="changeStatus()" data-url="{{ route('property_manager.sale.client.installment.un_paid', ['panel' => (new App\Helpers\Helpers)->user_login_route()['panel'], 'id' => $data->id]) }}" type="button" class="text-white btn btn-primary change_status" title="Detail">
...
=======
        function changeStatus(){
            var url = $('.change_status').attr('data-url');
            $('#statusForm').attr('action',url);
            $('#statusModal').modal('show');
        }
>>>>>>> e73d3dd94bd58f71271ee38c5a091babc3d277f5
