                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="building_id">
                                                    @forelse($building as $data)
                                                        <option value="{{ $data->id }}" {{ $building_sale->building_id == $data->id ? 'selected' : '' }}>{{ $data->name }}</option>
                                                    @empty
                            ...
                            <div class="card">
                                ...
                                <div class="card-body new-client-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label>Phone</label>
                                            <input type="number" class="form-control" name="phone_number" value="{{$building_sale->customer->phone_number}}" required>
                                            @error('phone_number')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                            @enderror
                                        </div>
