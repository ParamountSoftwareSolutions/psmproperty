            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <form method="post"
                              action="{{ route('property_manager.sale.client.update', ['panel' => (new App\Helpers\Helpers)->user_login_route()['panel'], 'client' => $building_sale->id]) }}">
                            <div class="card">
                                @csrf
                                @method('put')
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="building_id">
                                                    <option value="{{ $building_sale->building_id }}" selected>{{ $building_sale->building->name }}</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @else
                                                    <select class="form-control" name="floor_id" required>
                                                        ...
                                                        @foreach($building_sale->building->building_floor_detail as $data)
                                                        <option value="{{ $data->floor->id }}">{{ $data->floor->name }}</option>
                                                        @endforeach
                                                    </select>
                                                @endif
                                                @error('floor_id')
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="payment_plan_id">
                                                    <option value="{{ ($building_sale->payment == null ) ? '' : $building_sale->payment_plan_id }}" selected>
                                                        {{ ($building_sale->payment == null ) ? 'Select Payment Plan' : $building_sale->payment->name }}
                                                    </option>
                                                    @foreach($payment_plan as $plan)
                                                        <option value="{{$plan->id}}"
                                                                @if($building_sale->payment_plan_id == $plan->id) selected @endif>{{$plan->name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="sale_person_id" id="sale_person_id">
                                                    <option value="{{ ($building_sale->sale_person == null ) ? '' : $building_sale->sale_person_id }}" selected>
                                                        {{ ($building_sale->sale_person == null ) ? 'Select Sales Person' : $building_sale->sale_person->username }}
                                                    </option>
