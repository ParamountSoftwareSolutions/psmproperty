                                        ...
                                        @forelse($payment_plan as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button data-url="{{ route('property_manager.payment_plan.destroy', $data->id) }}" type="button" data-token="{!! csrf_token() !!}" title="Delete" class="btn btn-danger px-1 py-0 deleteBtn">
