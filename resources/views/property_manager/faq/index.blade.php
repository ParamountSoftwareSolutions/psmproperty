...
{{--                                            <th>Faqs</th>--}}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('property_manager.faq.edit', $faq->id) }}" class="btn btn-primary btn-sm mr-1 px-1 py-0"><i class="fa fa-pencil"></i></a>
                                                <a href="{{ route('property_manager.faq.destroy', $faq->id) }}" class="btn btn-primary btn-sm mr-1 px-1 py-0"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                            @empty
                                            @endforelse
