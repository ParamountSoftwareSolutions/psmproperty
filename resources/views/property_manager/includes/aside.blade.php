    ...
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ route('property_manager.dashboard')  }}">
                <img alt="image" src="{{ asset('public/panel/assets/img/logo.png') }}" class="header-logo" style="height:150px !important;margin: -15px 0px 10px 0px !important;padding: 30px"/>
            </a>
        </div>
...
{{--                </li>--}}
            ...
            @if(Helpers::isPropertyManager())
                ...
                @if(Helpers::building_detail()->count() > 1)
                ...
                <li class="dropdown @if (request()->routeIs('property_manager.income.index', 'property_manager.income.edit', 'property_manager.income.create','property_manager.income.report')) active @endif">
                    <a href="#" class="menu-toggle nav-link has-dropdown">
                        <i class="fa-sharp fa-solid fa-sack-dollar"></i>
                        <span>Income</span></a>
                    <ul class="dropdown-menu">
                        <li><a class="nav-link" href="{{ route('property_manager.income.index',Helpers::user_login_route()['panel']) }}">Income</a></li>
                        <li><a class="nav-link" href="{{ route('property_manager.income.create',Helpers::user_login_route()['panel']) }}">Add New</a></li>
                        <li><a class="nav-link" href="{{ route('property_manager.income.report',Helpers::user_login_route()['panel']) }}">Report</a></li>
                    </ul>
                </li>
            ...
            @if(Helpers::isSaleManager())
                ...
                <li class="dropdown @if (request()->routeIs('property_manager.my_targets')) active @endif">
                    <a href="#" class="menu-toggle nav-link has-dropdown">
                        <i class="fa-solid fa-user"></i><span>Task Manager</span></a>
                    <ul class="dropdown-menu">
                        <li><a class="nav-link" href="{{ route('property_manager.my_targets', Helpers::user_login_route()) }}">My Targets </a></li>
