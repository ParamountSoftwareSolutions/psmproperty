                                        ...
                                        @forelse($property as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" data-url="{{ route('property_manager.property.destroy',$data->id) }}" title="Delete" data-token="{!! csrf_token() !!}" class="btn btn-danger px-1 py-0 deleteBtn">
