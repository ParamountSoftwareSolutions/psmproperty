                ...
                <div class="row">
                    ...
                    <div class="example" id="example">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4 col-xs-4">
                                <div class="header-title"><h4>{{ $form->project_name }}</h4></div>
                            </div>
                            <div class="col-sm-4 col-md-4 col-xs-4">
                                <img src="{{ asset($form->developer_logo) }}" alt="logoppms"
                                     style="margin-bottom: 10px;width: 160px;"
                                     class="pull-right"/>
                            </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input id="S-OF" type="text" class="form-control" placeholder="S/O.D/O.W/O"
                                           required
                                           value="{{ $form->customer->father_name }}">
                                </div>
                            ...
                            <div class=" form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input id="Phone-No" type="email" class="form-control"
                                           placeholder="xxxx-xxxxxxx" required
                                           value="{{ $form->customer->phone_number }}">
                                </div>
