                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('property_manager.membership.edit', $form->id) }}" class="btn btn-primary"
                                       style="margin-left: auto; display: block;">Edit</a>
                                    <a href="{{ route('property_manager.membership.print.form', $form->id) }}" class="btn btn-primary"
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="customer_id">
                                                    <option value="{{ $form->customer_id }}">{{ $form->customer->username }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-4">
                            ...
                            <div class="card card-primary">
                                <div class="card-header ui-sortable-handle">
                                    <h4>developer_logo <small style="color: red">* (ratio 1:1)</small></h4>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <div>
                                            <div class="row mb-3">
                                                @if($form->developer_logo !== null)
                                                    <div class="col-3">
                                                        <img style="height: 200px;width: 100%" class="banner-image"
                                                             src="{{asset($form->developer_logo)}}">
                                                        {{--<a href=""
                                                           style="margin-top: -35px;border-radius: 0"
                                                           class="btn btn-danger btn-block btn-sm remove-image"
                                                           data-id="{{ $form->id }}">Remove</a>--}}
