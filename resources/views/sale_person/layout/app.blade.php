...
<body>
    ...
    <script>
        $('body').on('click', '.deleteBtn', function(e) {
                ...
                @if(Session() - > has('message')) var type = "{{ Session::get('alert') }}";
                switch (type) {
                    case 'info':
                        Toast.fire({
                            icon: 'info',
                ...
                @endif @if($errors - > any()) @foreach($errors - > all() as $error) Toast.fire({
                    icon: 'error',
                    title: '{{ $error }}'
                }); @endforeach @endif $(".custom-file-input").on("change", function() {
