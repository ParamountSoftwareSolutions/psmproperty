                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4>Employee List</h4>
                                <a href="{{ route('property_admin.employee.create') }}" class="btn btn-primary" style="margin-left: auto; display: block;">Add New</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($employee as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('property_admin.employee.edit', $data->id) }}"
                                                    ...
                                                    @endif--}}
                                                    <form
                                                        action="{{ route('property_admin.employee.destroy', $data->id) }}"
