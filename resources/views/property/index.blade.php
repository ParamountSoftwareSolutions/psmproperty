            ...
            <div class="col-span-12 lg:col-span-6 mt-8">
                ...
                <div class="intro-y box p-5 mt-12 sm:mt-5">
                    <div class="flex flex-col xl:flex-row xl:items-center">
                        <div class="flex">
                            <div>
                                <div class="text-theme-19 dark:text-gray-300 text-lg xl:text-xl font-medium">PKR 15,000</div>
                            ...
                            <div>
                                <div class="text-gray-600 dark:text-gray-600 text-lg xl:text-xl font-medium">PKR 10,000</div>
                    ...
                    <div class="mt-5">
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-6">-PKR 65</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-9">+PKR 119</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-6">-PKR 127</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-6">-PKR 115</div>
                            </div>
                        </div>
                        <div class="intro-x">
                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                ...
                                <div class="text-theme-6">-PKR 50</div>
                            </div>
                        </div>
