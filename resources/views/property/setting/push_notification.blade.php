                            ...
                            <form method="post" action="{{ route('property_admin.setting.update_push_notification') }}" autocomplete="off">
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
                                                    <label class="custom-switch pl-0">
                                                        ...
                                                        <span class="custom-switch-indicator"></span>
                                                        <span class="custom-switch-description">Lead Update</span>
                                                    </label>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        @php($sm=\App\Models\BuildingSetting::where(['user_id' => \Illuminate\Support\Facades\Auth::id(), 'user_type' => \Illuminate\Support\Facades\Auth::user()->roles[0]->name, 'key' => 'sale_mature'])->first()->value)
                                        @php($data=json_decode($sm,true))
                                        <div class="form-group col-md-6">
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
                                                    <label class="custom-switch pl-0">
                                                        <input type="checkbox" name="sale_mature_status" {{$data['status']==1?'checked':''}} class="custom-switch-input">
                                                        <span class="custom-switch-indicator"></span>
                                                        <span class="custom-switch-description">Sale Add Message</span>
                                                    </label>
                                                </div>
                                                <textarea name="sale_mature_message" class="form-control">{{$data['message']}}</textarea>
                                                @error('sale_mature_message')
                                                <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
                                                    <label class="custom-switch pl-0">
                                                        ...
                                                        <span class="custom-switch-indicator"></span>
                                                        <span class="custom-switch-description">Follow Up Message</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
                                                    <label class="custom-switch pl-0">
                                                        ...
                                                        <span class="custom-switch-indicator"></span>
                                                        <span class="custom-switch-description">Discussion Message</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
                                                    <label class="custom-switch pl-0">
                                                        ...
                                                        <span class="custom-switch-indicator"></span>
                                                        <span class="custom-switch-description">Negotiation Message</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
                                                    <label class="custom-switch pl-0">
                                                        ...
                                                        <span class="custom-switch-indicator"></span>
                                                        <span class="custom-switch-description">Lost Message</span>
                                                    </label>
                                                </div>
                                    ...
                                    <div class="row">
                                        @php($tr=\App\Models\BuildingSetting::where(['user_id' => \Illuminate\Support\Facades\Auth::id(), 'user_type' => \Illuminate\Support\Facades\Auth::user()->roles[0]->name, 'key' => 'transfer_rejected'])->first()->value)
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="transfer_rejected_message" class="form-control">{{$data['message']}}{{$data['message']}}</textarea>
                                    ...
                                    <div class="row">
                                        @php($fc=\App\Models\BuildingSetting::where(['user_id' => \Illuminate\Support\Facades\Auth::id(), 'user_type' => \Illuminate\Support\Facades\Auth::user()->roles[0]->name, 'key' => 'reserve_create'])->first()->value)
                                        @php($data=json_decode($fc,true))
                                        <div class="form-group col-md-6">
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
                                        ...
                                        @php($fa=\App\Models\BuildingSetting::where(['user_id' => \Illuminate\Support\Facades\Auth::id(), 'user_type' => \Illuminate\Support\Facades\Auth::user()->roles[0]->name, 'key' => 'reserve_accept'])->first()->value)
                                        @php($data=json_decode($fa,true))
                                        <div class="form-group col-md-6">
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
                                    ...
                                    <div class="row">
                                        @php($fr=\App\Models\BuildingSetting::where(['user_id' => \Illuminate\Support\Facades\Auth::id(), 'user_type' => \Illuminate\Support\Facades\Auth::user()->roles[0]->name, 'key' => 'reserve_rejected'])->first()->value)
                                        @php($data=json_decode($fr,true))
                                        <div class="form-group col-md-6">
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
                                        ...
                                        @php($fp=\App\Models\BuildingSetting::where(['user_id' => \Illuminate\Support\Facades\Auth::id(), 'user_type' => \Illuminate\Support\Facades\Auth::user()->roles[0]->name, 'key' => 'reserve_pending'])->first()->value)
                                        @php($data=json_decode($fp,true))
                                        <div class="form-group col-md-6">
                                            <div class="form-group">
                                                <div class="custom-switches-stacked mt-2">
