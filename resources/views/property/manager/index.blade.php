                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($manager as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('property_admin.manager.edit', ['manager' => $data->id]) }}"
                                                       class="btn btn-primary px-1 py-0">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    @if ($data->status == 0)
                                                        <a href="{{ route('property_admin.manager.activate', $data->id) }}"
                                                    ...
                                                    @else
                                                        <a href="{{ route('property_admin.manager.deactivate', $data->id) }}"
                                                           class="btn btn-primary px-1 py-0">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                 height="24" viewBox="0 0 24 24" fill="none"
                                                                 stroke="currentColor" stroke-width="2"
                                                    ...
                                                    @endif
                                                    <button type="button" data-url="{{ route('property_admin.manager.destroy', ['manager' => $data->id]) }}" data-token="{!! csrf_token() !!}" title="Delete" class="btn btn-danger px-1 py-0 deleteBtn">
