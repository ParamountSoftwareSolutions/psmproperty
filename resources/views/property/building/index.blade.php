                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('property_admin.building.create') }}" class="btn btn-primary"
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($buildings as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('property_admin.building.edit',$data->id) }}"
                                                    ...
                                                    {{--<a href="{{ route('property_admin.building_detail.index', $data->id) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('property_admin.building.destroy',$data->id) }}"
