                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4>Expense List</h4>
                                <a href="{{ route('accountant.expense.create') }}" class="btn btn-primary"
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($expenses as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->date}}</td>
                                                <td>
                                                    <a href="{{ route('accountant.expense.edit',$data->id) }}"
                                                       class="btn btn-primary px-1 py-0" title="Edit">
                                                       <i class="fa fa-edit"></i>

                                                    </a>
                                                    <form
                                                        action="{{ route('accountant.expense.destroy',$data->id) }}"
