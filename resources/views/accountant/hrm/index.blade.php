        ...
        <div class="col-span-12 xxl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-8">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5 bg">
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-gray-600 mt-1">Active Employees</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-3xl font-medium leading-8 mt-6">0</div>
                                    <div class="text-base text-gray-600 mt-1">Trash Employees</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-3xl font-medium leading-8 mt-6">0</div>
                                    <div class="text-base text-gray-600 mt-1">Salary Paid</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                ...
                <div class="col-span-12 lg:col-span-6 mt-8 bg-white">
                    <div class="intro-y block sm:flex items-center h-10">
                        <h2 class="text-lg font-medium truncate ml-5 text-danger">
                            Expense Report
                        </h2>
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-3 mt-8 bg-white">
                    <div class="intro-y flex items-center h-10">
                        <h2 class="text-lg font-medium truncate text-danger ml-2">
                            Weekly Top Seller
                        </h2>
                ...
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-3.jpg" title="Uploaded at 11 June 2022">--}}
                {{--</div>--}}
                {{--<div class="w-10 h-10 image-fit zoom-in -ml-5">--}}
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-8.jpg" title="Uploaded at 11 December 2020">--}}
                {{--</div>--}}
                {{--<div class="w-10 h-10 image-fit zoom-in -ml-5">--}}
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-11.jpg" title="Uploaded at 14 September 2021">--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--</td>--}}
                {{--<td>--}}
                ...
                {{--<div class="flex">--}}
                {{--<div class="w-10 h-10 image-fit zoom-in">--}}
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-13.jpg" title="Uploaded at 27 March 2021">--}}
                {{--</div>--}}
                {{--<div class="w-10 h-10 image-fit zoom-in -ml-5">--}}
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-3.jpg" title="Uploaded at 3 June 2020">--}}
                {{--</div>--}}
                {{--<div class="w-10 h-10 image-fit zoom-in -ml-5">--}}
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-2.jpg" title="Uploaded at 11 March 2021">--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--</td>--}}
                {{--<td>--}}
                ...
                {{--<div class="flex">--}}
                {{--<div class="w-10 h-10 image-fit zoom-in">--}}
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-4.jpg" title="Uploaded at 28 August 2020">--}}
                {{--</div>--}}
                {{--<div class="w-10 h-10 image-fit zoom-in -ml-5">--}}
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-3.jpg" title="Uploaded at 27 September 2021">--}}
                {{--</div>--}}
                {{--<div class="w-10 h-10 image-fit zoom-in -ml-5">--}}
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-7.jpg" title="Uploaded at 19 April 2022">--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--</td>--}}
                {{--<td>--}}
                ...
                {{--<div class="flex">--}}
                {{--<div class="w-10 h-10 image-fit zoom-in">--}}
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-6.jpg" title="Uploaded at 22 December 2022">--}}
                {{--</div>--}}
                {{--<div class="w-10 h-10 image-fit zoom-in -ml-5">--}}
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-12.jpg" title="Uploaded at 19 December 2022">--}}
                {{--</div>--}}
                {{--<div class="w-10 h-10 image-fit zoom-in -ml-5">--}}
                {{--<img alt="" class="tooltip rounded-full" src="dist/images/preview-15.jpg" title="Uploaded at 19 August 2022">--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--</td>--}}
                {{--<td>--}}
                ...
                {{--<div class="report-timeline__image">--}}
                {{--<div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">--}}
                {{--<img alt="" src="dist/images/profile-2.jpg">--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--<div class="box px-5 py-3 ml-4 flex-1 zoom-in">--}}
                {{--<div class="flex items-center">--}}
                ...
                {{--<img alt="" class="rounded-md border border-white" src="dist/images/preview-12.jpg">--}}
                {{--</div>--}}
                ...
                {{--<div class="report-timeline__image">--}}
                {{--<div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">--}}
                {{--<img alt="" src="dist/images/profile-1.jpg">--}}
                {{--</div>--}}
                {{--</div>--}}
                {{--<div class="box px-5 py-3 ml-4 flex-1 zoom-in">--}}
                {{--<div class="flex items-center">--}}
