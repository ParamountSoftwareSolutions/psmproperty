            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <form method="post" action="{{ route('accountant.employee.update', $employee->id) }}">
                                @csrf
                                @method('put')
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="job_title" required>
                                                    ...
                                                    <option value="sale_person" @if($employee->getRoleNames()[0] == 'sale_person') selected @endif>Sale Person</option>
                                                    <option value="office_staff" @if($employee->getRoleNames()[0] == 'office_staff') selected @endif>Office Staff</option>
                                                    <option value="accountant" @if($employee->getRoleNames()[0] == 'accountant') selected @endif>Accountant</option>
                                                </select>
                                                @error('job_title')
                                                <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
