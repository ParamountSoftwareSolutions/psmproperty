                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <ul class="nav nav-pills">
                                    <li class="nav-item">
                                        --}}{{--                                        <a class="nav-link active" href="{{ route('accountant.report.search', ['type'
                                        => Request::segment(3), 'time' => 'total']) }}">Total Sales <span class="badge badge-white">{{ 0 }}</span></a>--}}{{--
                                    </li>
                                    --}}{{--                                    <li class="nav-item">--}}{{--
                                    --}}{{--                                        <a class="nav-link" href="{{ route('accountant.report.search', ['type' =>
                                    Request::segment(3), 'time' => 'weekly']) }}">Weekly Sales <span class="badge badge-primary">2</span></a>--}}{{--
                                    --}}{{--                                    </li>--}}{{--
                                    --}}{{--                                    <li class="nav-item">--}}{{--
                                    --}}{{--                                        <a class="nav-link" href="{{ route('accountant.report.search', ['type' =>
                                    Request::segment(3), 'time' => 'monthly']) }}">Monthly Sales <span class="badge badge-primary">3</span></a>--}}{{--
                                    --}}{{--                                    </li>--}}{{--
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('accountant.report.expense_report') }}" method="get">
                                    @csrf
