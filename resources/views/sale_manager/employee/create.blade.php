            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <form method="post" action="{{ route('sale_manager.employee.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="job_title" required readonly="">
                                                    <option value="sale_person" selected>Sale Person</option>
                                                </select>
                                                @error('job_title')
                                                <div class="text-danger mt-2">{{ $message }}</div>
                                                @enderror
