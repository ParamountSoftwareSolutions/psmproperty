                            ...
                            <div class="card-header d-flex justify-content-right align-items-center">
                                ...
                                <div class="card-header-action">
                                    <div class="row justify-content-end">
                                        <form class="form-inline" method="POST" action="{{route('sale_manager.sale.lead.search')}}">
                                            @csrf
                                        ...
                                        <form class="form-inline" method="POST" action="{{route('sale_manager.sale.lead.searchByDate')}}">
                                            @csrf
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="dropdown">
                                                <a href="{{ route('sale_manager.sale.lead.create') }}" class="btn btn-info">Add New</a>
                                            </div>
                                        </div>
                                    </div>
                                    <form action="{{route('sale_manager.sale.lead.filter')}}" class="filter_form" method="POST">
                                        @csrf
                                    ...
                                    <form action="{{route('sale_manager.sale.lead.assign')}}" class="assign_form" method="POST">
                                        @csrf
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($sales as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->floor_detail->building->name ?? 'N/A'}}</td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start"
                                                             style="position: absolute; transform: translate3d(0px, 26px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                            <a href="{{route('sale_manager.sale.lead.change_priority',['very_hot',$data->id])}}"
                                                               class="dropdown-item has-icon @if($data->priority == 'very_hot') d-none  @endif">Very Hot</a>
                                                            <a href="{{route('sale_manager.sale.lead.change_priority',['hot',$data->id])}}"
                                                               class="dropdown-item has-icon @if($data->priority == 'hot') d-none @endif">Hot</a>
                                                            <a href="{{route('sale_manager.sale.lead.change_priority',['moderate',$data->id])}}"
                                                               class="dropdown-item has-icon @if($data->priority == 'moderate') d-none @endif">Moderate</a>
                                                            <a href="{{route('sale_manager.sale.lead.change_priority',['cold',$data->id])}}"
                                                ...
                                                <td>
                                                    <a href="{{ route('sale_manager.sale.lead.edit',$data->id) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('sale_manager.sale.lead.destroy',$data->id) }}"
                                                    ...
                                                    <a href="{{route('sale_manager.sale.lead.comments',$data->id)}}" class="btn btn-info btn-sm mt-3">Comments</a>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.change_status').on('click', function () {
                ...
                $('#form_id').val(id);
                $('#statusForm').attr('action', "{{route('sale_manager.sale.lead.change_status')}}");
                /*if (status == 'mature') {
