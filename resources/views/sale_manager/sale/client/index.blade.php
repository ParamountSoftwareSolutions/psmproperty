                            ...
                            <div class="card-header d-flex justify-content-right align-items-center">
                                ...
                                <div class="card-header-action">
                                    <div class="row justify-content-end">
                                        <form class="form-inline" method="POST" action="{{route('sale_manager.sale.client.search')}}">
                                            @csrf
                                        ...
                                        <form class="form-inline" method="POST" action="{{route('sale_manager.sale.client.searchbydate')}}">
                                            @csrf
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="dropdown">
                                                <a href="{{ route('sale_manager.sale.client.create') }}" class="btn btn-primary">Add New</a>
                                    ...
                                    <form action="{{route('sale_manager.sale.client.filter')}}" class="filter_form" method="POST">
                                        @csrf
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($sales as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('sale_manager.sale.client.edit',$data->id) }}"
                                                    ...
                                                    <a href="{{ route('sale_manager.sale.client.show', $data->id) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('sale_manager.sale.client.destroy',$data->id) }}"
...
<script>
    $(document).ready(function()
    {
        ...
        $('.change_status').on('click',function()
        {
            ...
            $('#form_id').val(id);
            $('#statusForm').attr('action',"{{route('sale_manager.sale.client.change_status')}}");
