<div id="add-apartment-modal1" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content p-5 pt-0">
            <div class="intro-y box py-10 sm:py-20">
                <div class="px-5 mt-10">
                    <div class="font-bold text-center text-2xl">Add Receipt Apartment Building</div>
                        ...
                        <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
                            ...
                            <div class="flex flex-col lg:flex-row px-5 sm:px-20 pt-10 pb-10 sm:pb-20">
                                <div>
                                    ...
                                    <div class="text-lg font-medium text-primary mt-2">{{auth()->user()->email}}</div>
