<div id="addInstallment-modal" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content p-5 pt-0">
            <div class="intro-y box">
                <form id="society-form" action="{{url('society/installment/add')}}" method="POST" enctype="multipart/form-data">
                    @csrf
