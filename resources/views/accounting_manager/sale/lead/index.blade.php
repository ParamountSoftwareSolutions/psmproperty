                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4>Leads</h4>
                                <a href="{{ route('property_manager.sale.lead.create') }}" class="btn btn-primary"
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($sales as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('property_manager.sale.lead.edit',$data->id) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('property_manager.sale.lead.destroy',$data->id) }}"
