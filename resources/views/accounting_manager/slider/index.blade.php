                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4>Slider List</h4>
                                <a href="{{ route('property_manager.slider.create') }}" class="btn btn-primary"
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        @forelse($sliders as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('property_manager.slider.edit',$data->id) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('property_manager.slider.destroy',$data->id) }}"
