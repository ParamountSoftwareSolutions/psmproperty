<div class="top-bar">
    ...
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Dashboard</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active mr-2">Index</a>
        @if($activePage == 'status')
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#statuscreation-modal-preview" class="btn btn-sm btn-primary">Add New Status</a> </div>
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#statusTypecreation-modal-preview" class="btn btn-sm btn-primary ml-1">Add New Status Type</a> </div>
        @elseif($activePage == 'noc')
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#noccreation-modal-preview" class="btn btn-sm btn-primary">Add New NOC</a> </div>
        @elseif($activePage == 'sector')
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#sectorcreation-modal-preview" class="btn btn-sm btn-primary">Add New Sector</a> </div>
        @endif
        @if($activePage == 'location')
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#provincecreation-modal-size-preview" class="btn btn-sm btn-primary mr-1">Add New Province</a> </div>
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#citycreation-modal-size-preview" class="btn btn-sm btn-primary">Add New City</a> </div>
        @endif
        @if($activePage == 'society_category')
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#categorycreateion-modal-size-preview" class="btn btn-sm btn-primary mr-1">Add New Category</a> </div>
        @endif
    </div>
    <!-- END: Breadcrumb -->
    <!-- BEGIN: Search -->
