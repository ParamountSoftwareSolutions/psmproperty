<div class="top-bar">
    ...
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Dashboard</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active mr-2" >Index</a>
        ...
        @endif
        @if($activePage == "possessions" )
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#addPossession-modal-size-preview" class="btn btn-primary btn-sm mr-1">Add New Possession</a> </div>
        @endif
    @if($activePage == "projects" )
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#addprojects-modal-size-preview" class="btn btn-primary btn-sm mr-1">Add New Projects</a> </div>
        @endif

        @if($activePage == "sales" && \App\Helpers\Permission::hasPermission(auth()->user(), 'Sales', 'can_create'))
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#addSale-modal-size-preview" class="btn btn-primary btn-sm mr-1">Add New Entry</a> </div>
        @endif
        @if($activePage == "employee" && \App\Helpers\Permission::hasPermission(auth()->user(), 'Employee', 'can_create'))
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#add-employee-modal" class="btn btn-primary btn-sm mr-1">Add New Employee</a> </div>
        @endif
        @if($activePage == "leads")
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#add-lead-modal" class="btn btn-primary btn-sm mr-1">Add New Lead</a> </div>
        @endif

        @if($activePage == "agent")
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#add-lead-modal" class="btn btn-primary btn-sm mr-1">Add New Agent</a> </div>
        @endif
        @if($activePage == "agent-edit")
            <div class="text-center"> <a href="javascript:;" data-toggle="modal" data-target="#add-lead-modal" class="btn btn-primary btn-sm mr-1">Edit Record</a> </div>
        @endif
    ...
    <div class="intro-x dropdown w-8 h-8">
        ...
        <div class="dropdown-menu w-56 text-white">
            <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6">
                ...
                <div class="p-2">
                    <a href="{{url('society/profile')}}" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                        <i data-feather="user" class="w-4 h-4 mr-2"></i> Profile </a>
                    <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="edit" class="w-4 h-4 mr-2 "></i> Add Account </a>
                    <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="lock" class="w-4 h-4 mr-2 "></i> Reset Password </a>
                    <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="help-circle" class="w-4 h-4 mr-2 "></i> Help </a>
                </div>
                <a href="{{url('/logout')}}" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="toggle-right" class="w-4 h-4 mr-2 text-white"></i> Logout </a>
