<div id="modal-make-client" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content p-5 pt-0">
            <div class="intro-y box py-10 sm:py-20">
                ...
                <form id="society-form" action="{{url('society/leads/make-client')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div id="steps-3" class="steps  mt-10 pt-10 border-t border-gray-200 dark:border-dark-5" style="display: none">
                        ...
                        <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                            <div id="tabs" class="intro-y col-span-12 sm:col-span-12">
                                    <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                                        <div class="intro-y col-span-12 sm:col-span-6">
                                            <label for="input-wizard-6" class="form-label">First Name</label>
                                            <input  name="first_name" id="first_name" type="text" class="form-control" placeholder="first name">
                                            <p class="text-danger sm:text-sm d-none" id="is-required_2-0">First Name is a required field</p>
                                        </div>
                                        <div class="intro-y col-span-12 sm:col-span-6">
                                            <label for="input-wizard-6" class="form-label">Last Name</label>
                                            <input name="last_name" id="last_name" type="text" class="form-control" placeholder="last name">
                                            <p class="text-danger sm:text-sm d-none" id="is-required_2-0">Last Name is a required field</p>
                                        </div>
                                        <div class="intro-y col-span-12 sm:col-span-6">
