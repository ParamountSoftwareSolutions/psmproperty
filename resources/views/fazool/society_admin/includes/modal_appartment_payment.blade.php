<div id="modal-payment-appartment" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content p-5 pt-0">
            <div class="intro-y box py-10 sm:py-20">
                <div class="px-5 mt-10">
                    <div class="font-medium text-center text-lg">Setup Payment For Apartments</div>
                    ...
                    <form  action="{{url('societyAdmin/updatePayment')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                            <div class="intro-y col-span-6 sm:col-span-6">
                                ...
                                <input type="number" class="form-control" name="processing_amount" id="processing-appartment-amount"/>

                                <label for="down-payment">Down Payment</label>
                                <input type="number" class="form-control" name="down_payment" id="down-appartment-payment"/>

                                <label for="monthly-installment">Monthly Installment</label>
                                <input type="number" class="form-control" name="monthly_installment" id="monthly-appartment-installment"/>

                                <label for="total-installment">Total Installments</label>
                                <input type="number" class="form-control" name="total_installment" id="total-appartment-installment"/>

                                <label for="big-installment">Big Installment</label>
                                <input type="number" class="form-control" name="big_installment" id="big-appartment-installment"/>

                                <label for="big-installment-period">No Of Big Installment In A Year</label>
                                <input type="number" class="form-control" name="big_installment_period" id="big-appartment-installment-period"/>

                                <label for="belting-amount">Belting Charges</label>
                                <input type="number" class="form-control" name="belting_amount" id="belting-appartment-amount"/>

                                <label for="possession-amount">Possession Charges</label>
                                <input type="number" class="form-control" name="possession_amount" id="possession-appartment-amount"/>

                                <label for="development-amount">Development Charges</label>
                                <input type="number" class="form-control" name="development_amount" id="development-appartment-amount"/>
