...
{{--                        <span>Email</span></a>--}}
{{--                    <ul class="dropdown-menu">--}}
{{--                        <li><a class="nav-link" href="{{ route('property_manager.email.compose') }}">Compose</a></li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
{{--            @endif--}}
            ...
            @if(Helpers::isPropertyManager())
                ...
                <li class="dropdown @if (request()->routeIs('property_manager.income.index', 'property_manager.income.edit', 'property_manager.income.create')) active @endif">
                    <a href="#" class="menu-toggle nav-link has-dropdown">
                        <i class="fa-sharp fa-solid fa-sack-dollar"></i>
                        <span>Income</span></a>
                    <ul class="dropdown-menu">
            ...
            @if(Helpers::isPropertyAdmin() || Helpers::isPropertyManager())
