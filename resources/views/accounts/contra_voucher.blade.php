              ...
              <div class="panel panel-bd lobidrag">
                <div class="panel-heading">
                  <div class="panel-title">
                    <h4>
                      <?php echo App\Helpers\Helpers::display('contra_voucher') ?>
                    </h4>
                  </div>
                </div>
                      ...
                      <table class="table table-bordered table-hover" id="debtAccVoucher">
                        ...
                        <tbody id="debitvoucher">
                          ...
                          <tr>
                            ...
                            <td>
                              <button class="btn btn-danger red contra_voucher_btn_right" type="button" value="<?php echo App\Helpers\Helpers::display('delete') ?>" onclick="contradeleteRow(this)"><i class="fa fa-trash-o"></i></button>
                            </td>
                          </tr>
