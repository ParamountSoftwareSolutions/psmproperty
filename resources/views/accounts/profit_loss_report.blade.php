                                        ...
                                        <div class="row" id="">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" name="dtpFromDate" value="" placeholder="<?php echo App\Helpers\Helpers::display('from_date') ?>" class="datepicker form-control" autocomplete="off" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" name="dtpToDate" value="" placeholder="<?php echo App\Helpers\Helpers::display('to_date') ?>" class="datepicker form-control" autocomplete="off" required>
                                                    </div>
                                                </div>
