 ...
 echo $data['company_info']->storename; ?>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <nobr>
                                                                        <date>
                                                                            <?php echo App\Helpers\Helpers::display('date') ?>: <?php echo $data['payment_info']->VDate; ?>
                                                                        </date>
                                                                    </nobr>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-left"><?php echo App\Helpers\Helpers::display('voucher_no'); ?> : <?php echo $data['payment_info']->VNo ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-left"><?php echo App\Helpers\Helpers::display('payment_type'); ?> : <?php echo  'Payment'; ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-left"><?php echo App\Helpers\Helpers::display('amount'); ?> : <?php echo $data['payment_info']->Debit; ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-left"><?php echo App\Helpers\Helpers::display('remark'); ?> : <?php echo $data['payment_info']->Narration; ?></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                <tr>

                                                    <td> <?php echo App\Helpers\Helpers::display('paid_by') ?>: <?php echo Auth::id(); ?>

                                                        <div class="supplier_payment_receipt_f_tp">
                                                            <?php echo App\Helpers\Helpers::display('signature') ?>
                                ...
                                <div class="panel-footer text-left">
                                    <a class="btn btn-danger" href="<?php echo route('accounts.supplier_payments'); ?>"><?php echo App\Helpers\Helpers::display('cancel') ?></a>
