                            ...
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>
                                            <?php echo App\Helpers\Helpers::display('journal_voucher') ?>
                                        </h4>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-bordered table-hover" id="debtAccVoucher">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center"><?php echo App\Helpers\Helpers::display('debit') ?></th>
                                                        <th class="text-center"><?php echo App\Helpers\Helpers::display('credit') ?></th>
                                                ...
                                                <tbody id="debitvoucher">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-danger red journal_voucher_btn_right" type="button" value="<?php echo App\Helpers\Helpers::display('delete') ?>" onclick="journaldeleteRow(this)"><i class="fa fa-trash-o"></i></button>
                                                        </td>
                                                    </tr>
