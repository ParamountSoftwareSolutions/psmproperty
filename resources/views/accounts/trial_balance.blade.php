                                        ...
                                        <div class="row" id="">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" name="dtpFromDate" value="" placeholder="<?php echo App\Helpers\Helpers::display('from_date') ?>" class="datepicker form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" name="dtpToDate" value="" placeholder="<?php echo App\Helpers\Helpers::display('to_date') ?>" class="datepicker form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="date" class="col-sm-4 col-form-label"></label>
                                                    <div class="col-sm-8">
                                                        <input type="checkbox" id="chkWithOpening" name="chkWithOpening" size="40" />&nbsp;&nbsp;&nbsp;<label for="chkWithOpening"><?php echo App\Helpers\Helpers::display('with_details') ?></label>
                                                    </div>
                                                </div>
