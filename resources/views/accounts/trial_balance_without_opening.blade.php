...
use Illuminate\Support\Facades\DB;
 ...
 echo App\Helpers\Helpers::display('trial_balance') ?></h4>
                  </div>
                </div>
                <div id="printArea">
                    ...
                    <table width="100%" class="table_boxnew" cellpadding="5" cellspacing="0">
                      <tr>
                        <td colspan="4" align="center">
                          <h3 class=" trial_balance_without_openingpxbtn_font_family"><?php echo App\Helpers\Helpers::display('trial_balance') ?><br />
                            <?php echo App\Helpers\Helpers::display('start_date'); ?> <?php echo $dtpFromDate; ?> <?php echo App\Helpers\Helpers::display('end_date'); ?> <?php echo $dtpToDate; ?></h3>
                        </td>
                      </tr>
                      <tr class="table_head">
                        <td width="20%" align="center" class="trial_balance_without_opening_tp"><strong><?php echo App\Helpers\Helpers::display('code') ?></strong></td>
                        <td width="50%" align="center" class="trial_balance_without_opening_tp"><strong><?php echo App\Helpers\Helpers::display('account_name') ?></strong></td>
                        <td width="15%" align="center" class="trial_balance_without_opening_tp"><strong><?php echo App\Helpers\Helpers::display('debit') ?></strong></td>
                        <td width="15%" align="center" class="trial_balance_without_opening_tp trial_balance_without_opening_tb_r"><strong><?php echo App\Helpers\Helpers::display('credit') ?></strong></td>
                      </tr>
                      <?php
                      $TotalCredit = 0;
                      $TotalDebit = 0;
                      ...
                      ?>
                      <tr class="table_head">
                        <td colspan="2" align="right" class="trial_balance_without_opening_Right"><strong><?php echo App\Helpers\Helpers::display('total') ?></strong></td>
                      ...
                      <tr>
                        <td colspan="4" align="center">
                          <table width="100%" cellpadding="1" cellspacing="20" class="trial_balance_without_opening_right_50px">
                            <tr>
                              <td width="20%" class="trial_balance_without_openingpx" align="center"><?php echo App\Helpers\Helpers::display('prepared_by') ?></td>
                              <td width="20%" class="trial_balance_without_openingpx" align="center"><?php echo App\Helpers\Helpers::display('account_official') ?></td>
                              <td width="20%" class="trial_balance_without_openingpx" align='center'><?php echo App\Helpers\Helpers::display('chairman') ?></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
