                            ...
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>
                                            <?php echo App\Helpers\Helpers::display('supplier_payment'); ?>
                                        </h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form method="POST" action="{{route('accounts.create_supplier_payment')}}">
                                        ...
                                        <div class="form-group row">
                                            <label for="adress" class="col-sm-2 col-form-label"><?php echo App\Helpers\Helpers::display('ptype') ?></label>
                                            <div class="col-sm-4">
                                                <select name="paytype" class="form-control" required="" onchange="bank_paymet(this.value)">
                                                    <option>Select Option</option>
                                                    <option value="1"><?php echo App\Helpers\Helpers::display('casp') ?></option>
                                                    <option value="2"><?php echo App\Helpers\Helpers::display('bnkp') ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row supplier_payment_form_dnone" id="showbank">
                                            <label for="adress" class="col-sm-2 col-form-label"><?php echo App\Helpers\Helpers::display('slbank') ?></label>
                                            <div class="col-sm-4">
                                                <select name="bank" id="bankid" class="form-control supplier_payment_form_w_100">
                                                    <option value=""><?php echo App\Helpers\Helpers::display('slbank') ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="table-responsive supplier_payment_form_mr_t">
                                            <table class="table table-bordered table-hover" id="debtAccVoucher">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center"><?php echo App\Helpers\Helpers::display('supplier_name') ?></th>
                                                    ...
                                                    <tr>
                                                        <td class="supplier_payment_form_mr_w_200px">
                                                            <select name="supplier_id" id="supplier_id_1" class="form-control" onchange="load_code(this.value,1)" required>
                                                                <option value=""><?php echo App\Helpers\Helpers::display('slsuplier') ?></option>
