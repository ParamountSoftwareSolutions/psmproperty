                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-body" id="printArea">
                                    <tr align="center">
                                        <td id="ReportName" class="vouchar_cash_tobody"><b><?php echo App\Helpers\Helpers::display('cscrv') ?></b></td>
                                    </tr>
                                    <div class="">
                                        <table class="datatable2 table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <td width="7%" height="25"><strong><?php echo App\Helpers\Helpers::display('sl') ?></strong></td>
                                                    <td width="15%" align="center"><strong><?php echo App\Helpers\Helpers::display('ac_code') ?></strong></td>
                                                    <td width="48%" align="center"><strong><?php echo App\Helpers\Helpers::display('ac_head') ?></strong></td>
                                                    <td width="15%" align="right"><strong><?php echo App\Helpers\Helpers::display('credit') ?></strong></td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="table_data">
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                    <td align="right"><strong><?php echo App\Helpers\Helpers::display('total') ?></strong></td>
                                                    <td align="right"><strong><?php printf("%.2f", $TotalCredit); ?></strong></td>
                                                </tr>

                                                <tr class="table_data">
                                                    <td height="45" valign="top" class="rptInWords" align="right"><?php echo App\Helpers\Helpers::display('iword') ?> :</td>
                                                ...
                                                <tr>
                                                    <td valign="top">&nbsp;</td>
                                                    <td valign="top"><?php echo App\Helpers\Helpers::display('ac_office') ?></td>
                                                    <td align="right" valign="top">&nbsp;</td>
