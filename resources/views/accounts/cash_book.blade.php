                            ...
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>
                                            <?php echo App\Helpers\Helpers::display('cash_book') ?>
                                        </h4>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-body" id="printArea">
                                        <tr align="center">
                                            <td id="ReportName" class="cash_book_reportname"><b><?php echo App\Helpers\Helpers::display('cash_book_voucher') ?></b></td>
                                        </tr>
                                        <div>
                                            ...
                                            <table width="100%" class="table_boxnew cash_book_lineheight" cellpadding="6" cellspacing="1">
                                                ...
                                                <tr align="center">
                                                    <td colspan="7">
                                                        <font size="+1" class="cash_book_family"> <strong><?php echo App\Helpers\Helpers::display('cash_book_report_on') ?> <?php echo $FromDate; ?> <?php echo App\Helpers\Helpers::display('to') ?> <?php echo $ToDate; ?></strong></font><strong>
                                                            </th>
                                                        </strong>
                                                </tr>
                                                <tr align="left">
                                                ...
                                                <tr class="table_data">
                                                    ...
                                                    <td width="5%">&nbsp;</td>
                                                    <td width="35%">&nbsp;</td>
                                                    <td colspan="2" align="right"><strong><?php echo App\Helpers\Helpers::display('opening_balance') ?></strong></td>
                                                ...
                                                <tr class="table_head">
                                                    ...
                                                    <td align="center"><strong><?php echo App\Helpers\Helpers::display('transaction_date') ?></strong></td>
                                                    <td align="center"><strong><?php echo App\Helpers\Helpers::display('voucher_no') ?></strong></td>
                                                    <td align="center"><strong><?php echo App\Helpers\Helpers::display('voucher_type') ?></strong></td>
                                                    <td align="center"><strong><?php echo App\Helpers\Helpers::display('particulars') ?></strong></td>
                                                    <td width="11%" align="right"><strong><?php echo App\Helpers\Helpers::display('debit') ?></strong></td>
                                                    <td width="11%" align="right"><strong><?php echo App\Helpers\Helpers::display('credit') ?></strong></td>
