                        ...
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <strong><?php echo App\Helpers\Helpers::display('update'); ?></strong>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <div class="form-group row">
                                                    <label for="firstname" class="col-sm-4 col-form-label"><?php echo App\Helpers\Helpers::display('coa_head') ?> *</label>
                                                    <div class="col-sm-8">
                                                        <select name="coahead" class="form-control" onchange="selectparenthead()" id="coahead" required>
                                                            <option value="" selected="selected"><?php echo App\Helpers\Helpers::display('coa_head') ?></option>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="table-responsive">
                                                    <table class="table table-striped" id="table-1">
                                                        ...
                                                        <tbody>
                                                            <?php App\Helpers\Helpers::allpheadtable($data['allheadname']); ?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
