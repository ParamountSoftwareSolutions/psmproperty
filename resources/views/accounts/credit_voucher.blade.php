              ...
              <div class="panel panel-bd lobidrag">
                <div class="panel-heading">
                  <div class="panel-title">
                    <h4>
                      <?php echo App\Helpers\Helpers::display('credit_voucher') ?>
                    </h4>
                  </div>
                </div>
                ...
                <form method="POST" action="{{route('accounts.create_credit_voucher')}}">
                    ...
                    <div class="form-group row">
                      <label for="ac" class="col-sm-2 col-form-label"><?php echo App\Helpers\Helpers::display('ac_head') ?></label>
                      <div class="col-sm-4">
                        <select name="cmbDebit" id="cmbDebit" class="form-control">
                          <option value='1020101'><?php echo App\Helpers\Helpers::display('ac_head') ?></option>
                      ...
                      <table class="table table-bordered table-hover" id="debtAccVoucher">
                        ...
                        <tbody id="debitvoucher">
                          ...
                          <tr>
                            ...
                            <td>
                              <button class="btn btn-danger red credit_voucher_btn_right" type="button" value="<?php echo App\Helpers\Helpers::display('delete') ?>" onclick="creditdeleteRow(this)"><i class="fa fa-trash-o"></i></button>
                            </td>
                          </tr>
