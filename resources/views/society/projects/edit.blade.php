        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content p-5 pt-0">
                <div class="intro-y box py-10 sm:py-20">
                    ...
                    <form id="data-form" action="{{url('society/projects/update', $project->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div id="steps-10" class="steps px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200 dark:border-dark-5">
                            ...
                            <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                                <div class="intro-y col-span-12 sm:col-span-6">
                                    ...
                                    <input id="name" name="name" type="text" value="{{ $project->name }}" onchange="checkPlotStatus('{{url('society/item/status')}}')" class="form-control is-required" placeholder="Enter Project Name" required>
                                ...
                                <div class="intro-y col-span-12 sm:col-span-6">
                                    ...
                                    <select id="type" name="type" class="form-select is-required" onchange="getCategoryAdditionalData('{{url('')}}')" required>
                                        <option value="{{ $project->type }}">{{ strtoupper( $project->type) }}</option>
                                ...
                                <div class="intro-y col-span-12 sm:col-span-6 pt-2">
                                    ...
                                    <input type="start-date" id="start" name="start_date" value="{{ $project->start_date }}"
                                ...
                                <div class="intro-y col-span-12 sm:col-span-6">
                                    ...
                                    <input id="area" type="text" name="area" value="{{ $project->area }}" onchange="checkPlotStatus('{{url('society/item/status')}}')" class="form-control is-required" placeholder="Enter Project Area" required>
                                </div>
                            </div>
